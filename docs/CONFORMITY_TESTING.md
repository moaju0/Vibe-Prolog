...
> **Last Updated**: 2025-12-10 19:10:38
...
- **Conforming (PASS)**: 233 (65.6%)
- **Non-conforming (FAIL)**: 122 (34.4%)

### Result Distribution

- **OK Results**: 100 (28.2%)
- **Syntax Errors**: 252 (71.0%)
- **Type Errors**: 0 (0.0%)
- **Other Errors**: 3 (0.8%)
...
- Conforming: 20/26 (76.9%)

### Operators (Tests 38-320)

- Conforming: 83/131 (63.4%)
...
| 42 | `writeq(a*(b+c)).` | OK | OK | PASS | OK | OK |  |
...
| 67 | `/**/ 1.0e- 9 = -(e(1.0),9).` | OK | OK | PASS | OK | OK |  |
| 68 | `/**/ writeq(1e).` | OK | EXCEPTION | FAIL | OK | OK | string index out of range |
| 69 | `/**/ writeq(1.0e).` | OK | EXCEPTION | FAIL | OK | OK | string index out of range |
...
| 93 | `writeq(-(1*2)).` | OK | OK | PASS | OK | OK |  |
...
| 153 | `X = '\9'.` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Error trying to pr... |
| 154 | `X = '\N'.` | OK | SYNTAX_ERROR | FAIL | SYNTAX_ERROR | OK | error(syntax_error(Error trying to pr... |
| 155 | `X = '\\' .` | OK | OK | PASS | OK | OK |  |
| 156 | `X = '\77777777777\'.` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated quote... |
| 157 | `a = '\x61\'.` | OK | OK | PASS | OK | OK |  |
...
| 165 | `integer(0''').` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated quote... |
...
| 258 | `X/*/*/=7.` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
